    ...
    public partial class home : Form
    {
        ...
        private void home_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.users_privilegesTableAdapter.FillBy(this.ContractorDataSet.users_privilage, int.Parse(LoginInfo.id));
        ...
        private void sittings_Click(object sender, EventArgs e)
        {
            try
            {
                LoginInfo.log("[" + this.Text + " " + this.Name + "] [" + (sender as dynamic).Text + " " + (sender as dynamic).Name + "] [" + new System.Diagnostics.StackTrace(1).GetFrame(0).GetMethod().Name + "]");
        ...
        private void notifyIcon1_BalloonTipClicked(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(this, "لقد وصلت الكمية الموجودة فى المخزن ( المتوفر ) لهذا المنتج أقل من المسموح بها ( الحد الأدنى )", "UPTOP - Contractor Notifications", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
