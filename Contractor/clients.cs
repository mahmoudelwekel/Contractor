...
namespace Contractor
{
    public partial class clients : Form
    {
        ...
        void clear_all()
        {
            try
            {
                // TODO: This line of code loads data into the 'contractorDataSet.clients' table. You can move, or remove it, as needed.
        ...
        private void Search_textBox_TextChanged(object sender, EventArgs e)
        {
            try
            {
                this.clientsTableAdapter.Search(this.contractorDataSet.clients, Search_textBox.Text);
            }
            catch (Exception errortext)
            {
                LoginInfo.log(" حدث خطأ فى " + this.Text + " " + this.Name.ToString() + " " + errortext.ToString());
        ...
        private void add_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (nameTextBox.Text != "" && nameTextBox.Text != null && nameTextBox.Text != string.Empty)
                {

                this.clientsTableAdapter.Insert(nameTextBox.Text, phoneTextBox.Text, national_idTextBox.Text, adressTextBox.Text, commentTextBox.Text, activeCheckBox.Checked);
        ...
        private void edit_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                LoginInfo.log("[" + this.Text + " " + this.Name + "] [" + (sender as dynamic).Text + " " + (sender as dynamic).Name + "] [" + new System.Diagnostics.StackTrace(1).GetFrame(0).GetMethod().Name + "]");
                if (nameTextBox.Text != "" && nameTextBox.Text != string.Empty && nameTextBox.Text != null)
                {
                    ...
                    if (result == DialogResult.Yes)
                    {
                        ...
                        if (product != null)
                        {
                            ...
                            this.clientsTableAdapter.Update(nameTextBox.Text, phoneTextBox.Text, national_idTextBox.Text, adressTextBox.Text, commentTextBox.Text, activeCheckBox.Checked, id);
