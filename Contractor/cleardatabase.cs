...
namespace Contractor
{
    public partial class cleardatabase : Form
    {
        ...
        private void sitting_Load(object sender, EventArgs e)
        {
            ...
            var items = new[] {
                    new { Text = "المسلمين و المستلمين", Value = "clients" },
                    new { Text = "أنواع الدفعات المالية", Value = "payment_type" },
                    new { Text = "الدفعات المالية", Value = "payments" },
                    new { Text = "المشاريع", Value = "projects" },
