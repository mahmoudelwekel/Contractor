    ...
    public partial class login : Form
    {
        ...
        private void loginbtn_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception errortext)
            {
                ...
                MessageBox.Show( "حدث خطأ فى تسجيل الدخول" + Environment.NewLine + Properties.Settings.Default.ContractorConnectionString + Environment.NewLine+ errortext.Message, "حدث خطأ", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }
